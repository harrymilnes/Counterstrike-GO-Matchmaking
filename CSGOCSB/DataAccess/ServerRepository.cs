...
namespace CSGOCSB.DataAccess
{
    public class ServerRepository
    {
        ...
        public void Initalise()
        {
            ...
            _servers.Add(ServerModel.CreateServer("SEAsia", new Margin(685, 268, 0, 0), "sgp-1.valve.net", "103.28.54.0-103.28.54.255,103.28.55.0-103.28.55.255,103.10.124.0-103.10.124.255"));
